         ...
         <div class="jumbotron jumbotron-fluid bg-dark conference-banner">
            <div class="overlay">
               <div class="container clearfix text-center">
                  ...
                  <h2>Annual Dental And Oral Health</h2>
                  <h5 class="text-white">August 28-29, 2019 Dubai, UAE</h5>
                  <h6 class="mt-3 text-white">Theme: Tomorrows Dentistry Today</h6>
               </div>
               <!-- /.container -->
            </div>
            <!-- /.overlay -->
               ...
               <div class="row">
                  <div class="col-xl-9 col-lg-8 col-12">
                    <form action="insert_data.php" method="post" enctype="multipart/form-data">
                       ...
                       <input type="hidden" class="form-control" name="conference" value="Dental">
