  ...
  <title>Submit Abstract - Oil, Gas & Petroleum Refinery Conference | RI Conferences</title>
         
         <div class="jumbotron jumbotron-fluid bg-dark conference-banner">
            <div class="overlay">
               <div class="container clearfix text-center">
                  <h5 class="text-white">Submit Abstract</h5>
                  <h2>World Congress On Oil and Gas	</h2>
                  <h5 class="text-white">October 23 ,24 2019 Dubai, UAE</h5>
                  <h6 class="mt-3 text-white">Theme: Greater adoption of low sulphur, higher octane fuels and plans for petrochemical expansion</h6>
               </div>
               <!-- /.container -->
            </div>
            <!-- /.overlay -->
               ...
               <div class="row">
                  <div class="col-xl-9 col-lg-8 col-12">
                    <form action="insert_data.php" method="post" enctype="multipart/form-data">
                       ...
                       <input type="hidden" class="form-control" name="conference" value="Oil refinery">
                       ...
                       <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <input type="text" id="inputCountry" name="user_country" class="form-control">
                          </div>
                          <div class="form-group">
