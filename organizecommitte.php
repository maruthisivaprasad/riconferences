...
?>
<title>Organize Committe | RI Conferences</title>
<div class="inner-banner">
    <div class="overlay">
        <div class="container clearfix">
            <h2>Organize Committe</h2>
            <ul>
                <li><a href="index.html">Home</a></li>
                <li>/</li>
                <li>Organize Committe</li>
            </ul>
        </div> <!-- /.container -->
    </div> <!-- /.overlay -->
</div> <!-- /.inner-banner -->
...
<div class="container">
        ...
        <div class="col-md-3">
            <a href="organizedetail.php"><img src="documents/organize/<?php echo $rec->image;?>" class="mb-2"></a>
